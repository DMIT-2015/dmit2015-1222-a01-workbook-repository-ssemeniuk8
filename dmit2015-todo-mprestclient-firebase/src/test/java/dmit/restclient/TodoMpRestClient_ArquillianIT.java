...
//
        ...
        assertEquals("Take a Coffee Break", lastTodo.getTask());
    ...
    void shouldCreate() {
        ...
        newTodo.setTask("Run Integration Tests");
    ...
    void shouldFindOne() {
        ...
        assertEquals("Run Integration Tests", existingTodo.getTask());
    ...
    void shouldUpdate() {
        ...
        assertNotNull(existingTodo);
        // Act
        existingTodo.setTask("Finish Integration Tests");
